...
const recipeMap = {
  ...
  'Attack 2': [{ ingredient: 'Hotdog', qty: 1 }, { ingredient: 'Footlong Buns', qty: 1 }, { ingredient: 'Halo-Halo', qty: 1 }, { ingredient: '22 oz Cups - Halo-Halo', qty: 1 }, { ingredient: 'Fries', qty: 1 }],
  ...
  'Tea 1': [{ ingredient: '22 oz Cups - Milktea', qty: 1 }, { ingredient: 'Burger Patty', qty: 1 }, { ingredient: 'Burger Buns', qty: 1 }, { ingredient: 'Fries', qty: 1 }],
  'Tea 2': [{ ingredient: '22 oz Cups - Milktea', qty: 1 }, { ingredient: 'Hotdog', qty: 1 }, { ingredient: 'Footlong Buns', qty: 1 }, { ingredient: 'Fries', qty: 1 }],
  'Tea 3': [{ ingredient: '22 oz Cups - Milktea', qty: 1 }, { ingredient: 'Fries', qty: 1 }],
  // MILKTEA & MILKSHAKES
  'Matcha Milktea': [{ ingredient: '22 oz Cups - Milktea', qty: 1 }],
  'Chocolate Milktea': [{ ingredient: '22 oz Cups - Milktea', qty: 1 }],
  'Red Velvet Milktea': [{ ingredient: '22 oz Cups - Milktea', qty: 1 }],
  'Salted Caramel Milktea': [{ ingredient: '22 oz Cups - Milktea', qty: 1 }],
  'Rocky Road Milktea': [{ ingredient: '22 oz Cups - Milktea', qty: 1 }],
  'Cookies and Cream Milktea': [{ ingredient: '22 oz Cups - Milktea', qty: 1 }],
  ...
  'Halo-Halo': [{ ingredient: 'Halo-Halo', qty: 1 }, { ingredient: '22 oz Cups - Halo-Halo', qty: 1 }],
